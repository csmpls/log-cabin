...
def bytesToInt(bytes):
    return 255 * 255 * bytes[0] + 255 * bytes[1] + bytes[2]
                ...
                if ord(code) < 0x80:
                    ...
                    if code == RAW_EEG:
                        ...
                        for i in range(0,24, 4):
                            power_vals.append(bytesToInt(data[i:i+4]))
                        
                        for handler in self.headset.power_val_handlers:
                            handler(self.headset, power_vals)
